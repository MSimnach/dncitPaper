#' Title: Plotting functions for rejection rates of DNCITs
#'
#' change manually and run line by line
#'
#' @return returns two plots with all rejection rates of all settings and all DNCITs
#' @export
sim_ukb_brainmri_plots <- function() {
